...
class Simulator {
    static void Main() {
        ...
        var interval = TimeSpan.FromSeconds(111.0 / 1.0); // 1.0 / 777.0 =  777 Hz update rate means we want to update every 1/777 seconds, so we calculate that interval here
